...
The REPL is integrated with the rich content protocol described in \href{./COMMUNICATION.tex}{COMMUNICATION.tex}. If an expression evaluates to a type that implements the \texttt{Display} typeclass, its output is automatically wrapped in the rich content markers and rendered as HTML, LaTeX, or Markdown in the notebook.
